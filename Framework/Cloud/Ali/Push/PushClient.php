 ...
 */
namespace Cntysoft\Framework\Cloud\Ali\Push;
...
class PushClient
{
   ...
   {
      $config = ConfigProxy::getFrameworkConfig('Cloud');
      $this->appkey = $config->cloudpush->accessKey;
      $this->secretKey = $config->cloudpush->accessKeySecret;
   }
...
//      $requestClassName = ucfirst($inflector->camelize(substr($paramsArray["method"], 17))) . "Request";
